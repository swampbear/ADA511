...
def prob_tenth_patient_urgent(p_list, patient_sequence):
    ...
    new_n = n+1
    seq_prob = calculate_sequence_probability(p_list, n)
    seqand10_prob = calculate_sequence_probability(p_list, new_n)
...
def calculate_sequence_probability(joint_probs,i):
